...
fn print_suit(card: PokerSuit) {
    ...
    println!("{:?}",card);
}   Compiling playground v0.0.1 (/playground)error[E0412]: cannot find type `PokerSuit` in this scope --> src/main.rs:9:21  |9 | fn print_suit(card: PokerSuit) {  |                     ^^^^^^^^^ not found in this scopeerror[E0433]: failed to resolve: use of undeclared type `PokerSuit` --> src/main.rs:2:17  |2 |     let heart = PokerSuit::Hearts;  |                 ^^^^^^^^^ use of undeclared type `PokerSuit`error[E0433]: failed to resolve: use of undeclared type `PokerSuit` --> src/main.rs:3:19  |3 |     let diamond = PokerSuit::Diamonds;  |                   ^^^^^^^^^ use of undeclared type `PokerSuit`Some errors have detailed explanations: E0412, E0433.For more information about an error, try `rustc --explain E0412`.error: could not compile `playground` (bin "playground") due to 3 previous errors
```
